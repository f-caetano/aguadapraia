...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-accent text-[var(--cp-accent-fg)] hover:opacity-90',
        ghost: 'bg-transparent text-muted hover:bg-[var(--cp-accent-soft)] hover:text-accent',
        outline:
          'border border-border bg-surface text-foreground hover:bg-[var(--cp-accent-soft)] hover:text-accent',
      },
      size: {
